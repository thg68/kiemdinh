/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: d4335853dd5bed58b50ec730582300b3)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	OBSERVABILITY_RATE_LIMITER: RateLimit;
	...
	WORKER_SELF_REFERENCE: Fetcher /* kiemdinh-app-staging */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		NEXT_PUBLIC_SUPABASE_ANON_KEY: string;
		NEXT_PUBLIC_APP_URL: string;
		WORKER_SELF_REFERENCE: Fetcher /* kiemdinh-app-staging */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "NEXT_PUBLIC_APP_URL">> {}
}
